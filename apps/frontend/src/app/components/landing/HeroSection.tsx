  ...
  return (
    <section className="relative overflow-hidden bg-dot-grid">
      ...
      <div className="relative mx-auto max-w-[820px] px-4 pb-14 pt-16 md:pb-20 md:pt-20 text-center md:px-8 md:pb-28 md:pt-28">
        <span className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface-raised px-3.5 py-1.5 text-xs font-semibold uppercase tracking-[0.08em] text-ink-muted animate-fadeUp">
